package pertemuan11_graph_adjacency_matrix;
import java.io.*;
import java.util.*;

public class Pertemuan11_Graph_Adjacency_Matrix {
        ...
        for(int i = 0; i < adjMat.length; i++) {
            ...
            for(int j = 0; j < adjMat.length; j++) {
                if(adjMat[minDistVertex][j] != 0 && visited[j] == 
                        false && distance[minDistVertex] != Integer.MAX_VALUE) {
    ...
    public static int findMinDistVertex(int[] distance, boolean [] visited) {
        ...
        //traversing through the distance array and finding 
//        the least distance vertex whose visited is also false
