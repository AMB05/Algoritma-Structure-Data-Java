...
public class kelas_Induk {
    ...
    void virus ()                                                               //method 
    {
        ...
        if (jwb.equalsIgnoreCase("y"))                                          //memulai percabangan jika jawab ya
        {
            ...
            input.next();
            hari=input.nextInt();                                               //input dengan tipe data integer
    ...
    void saran ()                                                               //method saran
    {
        ...
        System.out.println("Patuhilah Agar Kamu Tidak Virus CORONA ");                    //tampilan method
