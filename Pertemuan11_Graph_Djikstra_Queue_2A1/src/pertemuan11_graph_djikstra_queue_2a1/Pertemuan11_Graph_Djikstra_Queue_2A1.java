package pertemuan11_graph_djikstra_queue_2a1;
import java.util.*;  

public class Pertemuan11_Graph_Djikstra_Queue_2A1 {
    ...
    public Pertemuan11_Graph_Djikstra_Queue_2A1(int totalNodes)  
    {  
    ...
    public static void main(String[] args) {
        ...
        adjacent.get(0).add(new Node(1, 3));  //0 = nilai 1 = tujuan 3 = jarak
        ...
        Pertemuan11_Graph_Djikstra_Queue_2A1 obj = new 
        Pertemuan11_Graph_Djikstra_Queue_2A1(totalNodes);  
